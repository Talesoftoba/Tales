  ...
  return (
    <>
      ...
      <main className="page-bg relative flex justify-center min-h-screen overflow-x-hidden font-body">
        ...
        {/* shared column — narrow on mobile, wider on desktop */}
        <div className="relative z-10 w-[96vw] max-w-[520px] md:max-w-none md:w-[92vw] flex flex-col pt-4 pb-4 md:py-8"
          style={{ height: "100dvh" }}
        >
          {/* header */}
          ...
          {/* white card — scrolls internally on both mobile and desktop */}
          <div
          ...
          >
            <div
              ...
              className="px-7 pt-8 pb-6 md:px-12 md:pt-12"
            >
              {children}
            </div>
          </div>
