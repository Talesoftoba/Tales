  ...
  return (
    <>
      ...
      >
        ...
        {/* floating site tag — pushed left enough to never clash with header */}
        ...
        <div className="relative z-10 w-[min(415px,92vw)]">
          ...
          {/* ── header: avatar left, contact button right ──
              pr-[120px] reserves space so the fixed site-tag never overlaps
              the ContactButton on narrow screens                            */}
          ...
          {/* ── white card: flex-col so nav is always pinned to bottom ── */}
          <div
            className="w-full bg-white rounded-[26px] shadow-[0_2px_4px_rgba(0,0,0,0.04),0_16px_56px_rgba(0,0,0,0.13)] flex flex-col"
            style={{ height: "min(87vh, 770px)" }}
          >
            {/* scrollable content area — grows to fill, nav stays at bottom */}
            <div
              id="card"
              style={{
                overflowY: "auto",
