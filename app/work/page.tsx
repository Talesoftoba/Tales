  ...
  return (
    <CardShell>
      ...
      <div className="md:hidden">
        <div className="mb-8">
          <p className="font-display text-[10px] font-bold tracking-[0.18em] uppercase text-[#1a1a1a] mb-2">Selected Work</p>
            ...
            <Link key={title} href={link} target="_blank" rel="noopener noreferrer"
              ...
              <div className="p-5">
                <div className="flex items-start justify-between mb-2">
                  <p className="font-display text-[14.5px] font-bold text-[#000000] group-hover:text-[#FF5C00] transition-colors duration-200">{title}</p>
      ...
      <div className="hidden md:block">
        <div className="mb-10">
          <p className="font-display text-[10px] font-bold tracking-[0.18em] uppercase text-[#1a1a1a] mb-2">Selected Work</p>
          <h1 className="font-display font-extrabold leading-[1.02] tracking-[-0.04em] text-[#000000]"
        ...
        <div className="grid grid-cols-2 gap-5">
          {PROJECTS.map(({ title, desc, tags, year, link, image }) => (
            <Link key={title} href={link} target="_blank" rel="noopener noreferrer"
              ...
              <div className="p-5">
                <div className="flex items-start justify-between mb-2">
                  <p className="font-display text-[14px] font-bold text-[#000000] group-hover:text-[#FF5C00] transition-colors duration-200">{title}</p>
                  <span className="font-display text-[9px] font-bold uppercase text-[#1a1a1a] shrink-0 ml-2">{year}</span>
                </div>
                <p className="font-body text-[12.5px] text-[#1a1a1a] leading-relaxed mb-3">{desc}</p>
                <div className="flex flex-wrap gap-1.5">
