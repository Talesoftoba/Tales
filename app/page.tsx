        ...
        <div className="flex items-center gap-2 flex-wrap mb-10">
          {[
            ...
            <Link key={label} href={href} target={target ? "_blank" : undefined} rel={target ? "noopener noreferrer" : undefined}
              className="flex items-center gap-2 border border-black/[0.14] rounded-full px-4 py-2 font-display text-[11px] font-bold
               tracking-[0.07em] uppercase text-[#111111] no-underline hover:border-[#FF5C00] hover:text-[#FF5C00] hover:bg-[#FF5C00]/4
        ...
        <section className="mb-11">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {STACK.map(({ name, Icon, color }) => (
              ...
              rounded-full border border-black/10 text-[#111111] hover:border-[#FF5C00] hover:text-[#FF5C00] hover:bg-[#FF5C00]/3 
        ...
        <section className="mb-4">
          ...
          <div className="flex flex-col gap-3.5">
            {WORK.map(({ title, tag, desc }) => (
              <div key={title} className="border border-black/8 rounded-2xl p-5 hover:border-[#FF5C00] hover:-translate-y-px transition-all
