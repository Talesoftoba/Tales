      ...
      <div className="hidden md:block">
        ...
        <section className="mb-14">
          ...
          <div className="flex flex-wrap gap-2.5 mt-4">
            {STACK.map(({ name, Icon, color }) => (
              <span key={name} className="flex items-center gap-2 font-display text-[11px] font-semibold tracking-[0.04em] px-4 py-2 rounded-full border border-black/10 text-[#111111] hover:border-[#FF5C00] hover:text-[#FF5C00] hover:bg-[#FF5C00]/3 transition-all duration-200 cursor-default group">
